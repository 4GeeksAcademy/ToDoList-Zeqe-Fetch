...
const ToDoApp = () => {
  ...
  useEffect(() => {
    fetch('https://playground.4geeks.com/todo/users/ezebellino', {
      method: 'GET',
      headers: {
  ...
  function keyDownFunction(e) {
    ...
    if (e.key === "Enter") {
      fetch('https://playground.4geeks.com/todo/todos/ezebellino', {
        method: 'POST',
        body: JSON.stringify({
          "label": todo.trim(),
          "is_done": false
      ...
      <div className="todo-list text-start border">
        <div className="todo-list-input">
          <input type="text"
            ...
            placeholder="Agrega una tarea por favor!"
        ...
        <div className="footer">
          ...
          <button className="deleterAll" onClick={deleteAllTasks}>Clear all tasks</button>
        </div>
      </div>
    </div>
  );
